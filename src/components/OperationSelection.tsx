...
const OperationSelection = () => {
  ...
  const [learnerModeEnabled, setLearnerModeEnabled] = useState(settings.useLearnerMode || false);
  ...
  useEffect(() => {
    ...
    setLearnerModeEnabled(settings.useLearnerMode || false);
  ...
  const handleStartGame = () => {
    ...
    updateSettings({
      ...
      useLearnerMode: learnerModeEnabled,
